            ...
            <div className="min-h-screen flex items-center justify-center bg-bg">
                ...
                <div className="bg-bg-card p-8 rounded-2xl border border-border w-full max-w-sm mx-4 shadow-[var(--shadow-lg)] animate-fade-in-scale">
                    <div className="text-center mb-8">
                        <div className="flex justify-center mb-3 text-fg animate-fade-in"><DatabaseIcon /></div>
                        <h1 className="text-2xl font-bold text-fg">{t('database.title')}</h1>
                        <p className="text-fg-muted mt-1 text-sm">{t('database.subtitle')}</p>
                    </div>
                ...
                <div className="max-w-[1600px] mx-auto px-4 sm:px-6 py-3">
                    <div className="flex items-center justify-between">
                        <div className="relative flex items-center gap-2.5 text-fg">
                            ...
                            >
                                <KeyIcon />
                                <h1 className="text-base font-semibold">{t('database.title')}</h1>
                                <ChevronDownIcon />
                            </button>
                            {navOpen && (
                                <>
