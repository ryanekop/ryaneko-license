...
export default function VendorFastpikPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            try {
                if (formLogoFile) {
                    const uploaded = await uploadVendorAsset({ product: 'fastpik', tenantSlug: slugForPayload, assetType: 'logo', file: formLogoFile });
                    nextLogoUrl = uploaded.url;
                    uploadedUrls.push(uploaded.url);
                }
                if (formFaviconFile) {
                    const uploaded = await uploadVendorAsset({ product: 'fastpik', tenantSlug: slugForPayload, assetType: 'favicon', file: formFaviconFile });
                ...
                if (editingTenant) {
                    ...
                    void cleanupVendorAssets({ product: 'fastpik', tenantSlug: slugForPayload, urls: replacedUrls });
                }
                ...
                await cleanupVendorAssets({ product: 'fastpik', tenantSlug: slugForPayload, urls: uploadedUrls });
                throw error;
            }
        } catch (error) {
